  ...
  return (
    ...
    <HashRouter>
      ...
      <Routes>
        ...
        <Route path="/" element={<ItemListContainer greeting="Tienda de Wolf Informatica"/>} />
        <Route path="/cart" element={<CartView greeting="Este es su carrito"/>} />
        {/* <Route path="/coderhouse-react" exact component={<ItemListContainer greeting="Bienvenido a Wolf Informatica!"/>} /> */}
